...
box-shadow: -1px 0px 17px -6px rgba(0,0,0,0.8); padding:0px 13px ">
  ...
  <p class="container" style="line-height: 1.5em; margin-top: 9px;"> 
...
Provided also that on attainment of the age of sixty-five years, such privileges shall be restricted to that of Private Pilot´s Licence (Aeroplanes).
   ...
   <p class="container" style="line-height: 1.5em; margin-top: 9px;" hidden="">This course is much similar to the CPL course except for the fact that you also receive 15 hours of training on a multi engine aircraft for issue of multi engine rating and the training required for issue of instrument rating which is beneficial for you when you apply in any airline. Since instrument rating is a must in airlines and having a multi engine rating gives you added advantage over other applicants.
<br><br>
...
<b>(e) Skill–</b> He shall have demonstrated to the satisfaction of the Examiner his competency as an Assistant Flight Instructor by performing the procedures and manoeuvres prescribed in the syllabus within a period of six months immediately preceding the
   ...
   <p class="container" style="line-height: 1.5em; margin-top: 9px;" hidden="">Content required</p>
   <p class="container" style="line-height: 1.5em; margin-top: 9px;" hidden="">
