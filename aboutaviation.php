...
<img src="img/aboutAviation/1.jpg" style="width:100%;margin-top: 5px;">
<ul class="nav nav-tabs" style="margin-top: 10px;">
  <li class="nav-item" >
    <a class="nav-link active" href="#">About Aviation</a>
  </li>
</ul>
...
<br><br>
A presentation of the cuttings of news paper articles/reports can be found at the following link for further guidance: AVIATION ARTICLES
<br><br>
<a href="ns-oper.pdf" target="_blank">CLICK HERE</a> for the List of Non-scheduled operators
<br><br>
<a href="sch-oper.pdf" target="_blank">CLICK HERE</a> for the List of Scheduled operators
<br><br>
<a href="#">CLICK HERE</a> to view the Statistics of Aircraft
</p>
